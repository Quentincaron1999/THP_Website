...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-lg sticky-top text-center d-xl-flex align-self-start order-1 justify-content-xl-center align-items-xl-center navigation-clean-button" style="background-color: #276746;">
        <div class="container-fluid"><a class="navbar-brand" href="#" style="color: rgb(255,255,255);">Accompagnement</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div>
                        <section>
                            <h1 id="Details" class="title" style="font-family: 'Zen-Its Sans';margin-left: 0%;margin-right: 3%;">En bref</h1><img src="assets/img/fhiagzf.png">
                            <p class="text-justify" style="margin-right: 2%;margin-left: 0%;margin-top: 3%;">Avec la THP académie, nous souhaitons vous proposer une approche holistique du trail. C’est pourquoi en plus d’aborder les techniques de courses, nous évoquons également le Yoga et la nutrition afin de vous proposer plusieurs
                                pistes d’amélioration et de découverte de nouvelles sensations.<br></p>
                        </section>
                        ...
                        <section style="margin-top: 6%;">
                            ...
                            <p class="text-justify"
                                style="margin-right: 2%;margin-left: 0%;">C’est un axe intéressant à développer pour vous permettre de repousser vos limites encore plus loin et augmenter votre plaisir pendant les courses.</p>
                        ...
                        <section style="margin-top: 6%;">
                            ...
                            <div class="text-left" style="margin-top: 4%;margin-bottom: 3%;margin-left: 75px;"><a class="btn btn-dark" data-toggle="collapse" aria-expanded="false" aria-controls="collapse-1" href="#collapse-1" role="button" style="background-color: #276746;">Offre "THP académie Ivory"<i class="fas fa-plus" style="margin-left: 40px;"></i></a>
                                <div
                ...
                <div class="text-left" style="margin-top: 4%;margin-bottom: 3%;margin-left: 75px;"><a class="btn btn-dark" data-toggle="collapse" aria-expanded="false" aria-controls="collapse-1" href="#collapse-1" role="button" style="background-color: #276746;">Offre "THP académie Gold"<i class="fas fa-plus" style="margin-left: 40px;"></i></a>
                    <div
                        class="collapse" id="collapse-1">
