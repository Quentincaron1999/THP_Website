                ...
                <div class="col-md-8">
                    <div>
                        <section>
                            ...
                            <p class="text-justify" style="margin-right: 2%;margin-left: 0%;margin-top: 3%;">Avec la THP académie, nous souhaitons vous proposer une approche holistique du trail. C’est pourquoi en plus d’aborder les techniques de courses, nous évoquons également le Yoga et la nutrition afin de vous proposer plusieurs
                                pistes d’amélioration et de découverte de nouvelles sensations.<br>
                            </p>
                        </section>
                        <section style="margin-top: 6%;">
                            <h1 id="Dates" class="title" style="font-family: 'Zen-Its Sans';margin-left: 0%;margin-right: 3%;">Plan d'entraînement personnalisé</h1>
...
<li>Partage en ligne d’un plan d’entraînement interactif<br><br></li>
                        ...
                        <section style="margin-top: 6%;">
                            <h1 id="Programme" class="title" style="font-family: 'Zen-Its Sans';margin-left: 0%;margin-right: 3%;">Nutrition</h1>
