...
<body style="background-color: #276746;font-size: 1.2em;" class="ivoire">
    ...
    <div style="margin-bottom: 28px;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <section class="tile-home ipad" style="min-width: 0px;height: 100%;background-repeat: no-repeat;background-size: cover;margin-bottom: 0%;margin-top: 2.5%;margin-right: 0%;background-color: #276746;">
                ...
                <div class="col-md-6">
                    ...
                    <p class="text-left" style="margin-left: 40px;margin-right: 40px; font-weight: bold;"><br>Présentation</p>
                        ...
                        <p class="text-left"
                            style="margin-left: 40px;margin-right: 40px; font-weight: bold;"><br>Principaux résultats</p>
                        <ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile-home ipad" style="min-width: 0px;height: 100%;background-repeat: no-repeat;background-size: cover;margin-bottom: 0%;margin-left: 0%;margin-right: 0%;background-color: #276746;">
                    <img style="width: 100%;height: 30%;background-position: center;background-size: contain;margin-top: 10%" src="assets/img/JulienC1.jpg">
